...
def remove_visual_noise(text: str):
    ...
    for line in lines:
        ...
        # Dłuższe linie ignorujemy – ocali to wszystkie instrukcje i pełne zdania.
        if len(stripped) < 40:
...
def main():
    # Zaktualizowałem nazwę pliku wejściowego na parsed_owu_2.md zgodnie z Twoim kodem
    input_path = "data/processed/parsed_owu_2.md"
